<template>
  <div class="page author">
      ...
      <div class="column xs-100 sm-80">
        ...
        <div class="author-joined">
          ...
          <time-provider type="ago" :date="$page.frontmatter.created_at">
            <span class="author-joined__text" slot-scope="{ time }">{{ $t('joined') }} {{ time }}</span>
          </time-provider>
        </div>
        ...
        <div class="author-social">
          <ul class="author-social__list">
            ...
            >
              ...
              >
                <span
                  class="icon author-social__icon"
    ...
    <section class="row posts-grid">
      <div class="column md-50 mt-30" v-for="post in getPostsByAuthor(0)" :key="post.key">
        <card-post :item="post" cover="right"/>
      </div>
    </section>
  </div>
</template>

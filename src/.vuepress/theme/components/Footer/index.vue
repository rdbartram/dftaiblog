<template>
  <footer class="footer">
    ...
    <section class="footer-box3">
      <div class="row">
        <div class="column sm-75 footer-card">
        ...
        <div class="column sm-25 footer-nav">
...
export default {
  ...
  components: {
    CardAuthor: () =>
      import(/* webpackChunkName = "CardAuthor" */ "@theme/components/CardAuthor"),
    Newsletter: () =>
